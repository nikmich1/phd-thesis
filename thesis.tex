...
%----------------------------------------------------------------------
  \cleardoublepage
  \phantomsection
  \addcontentsline{toc}{part}{Appendix} %\protect\large
  \appendix


  \chapter{Dirac equation in spherically symmetric field \label{app:dir_sph}}
    \input{appendix/dirac_sph}
...
%----------------------------------------------------------------------
  ...
  \bibliography{mybib-articles,mybib-tdr,mybib-books,mybib-comments,mybib-web}
    %\citestyle{egu}
    \bibliographystyle{osajnl-mod}
