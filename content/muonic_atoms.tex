...
\begin{figure}%
\centering
\subfloat[]{\label{fig:comp54exp}\includegraphics[width=0.92\linewidth]{pics/comparison_54}}\\
\subfloat[]{\label{fig:comp54theo}\includegraphics[width=0.95\linewidth]{pics/comparison_exp}}
\caption{
...
In part (b), the colored functions show the predicted signal for each transition. The center corresponds to the calculated transition probability and the shape is given by the natural line width and the detector response function. Details about the calculations can be found in Section~\ref{sec:muon_re}, and about the detector response function in Ref.~\cite{vogiatzi2018}.
}
\label{fig:re54}
\end{figure}
%
