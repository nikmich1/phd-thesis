...
Furthermore, the low-lying $2p\rightarrow1s$ and $3d\rightarrow 2p$ transitions, or $K$ and $L$ x rays, have been measured during the same experiments. The calculations in this thesis show that the assumption of statistically populated $5g$ states and a cascade as explained in Sec.~\ref{sec:transitions} can explain the spectrum qualitatively, using the rigid rotor model for the nucleus (Appendix~\ref{app:rig_rotor}). For the calculations of the spectra, the first five nuclear rotational states have been considered. In principle, from these spectra, the nuclear RMS radius can be extracted~\cite{hitlin1970}. However, for the low-lying transitions in heavy muonic atoms, the nuclear polarization corrections, e.g.~\cite{chen1970}, have to be considered. These corrections are due to virtual excitations of nuclear states beyond the rigid rotor model and have to be treated with a more accurate nuclear model or experimental data on nuclear transitions. Thus, updated calculations from the nuclear physics side would be desirable in order to extract nuclear charge radii in connections with the calculations from the muonic side as presented in this thesis, see also the conclusion \& outlook chapter.
