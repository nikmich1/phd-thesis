...
\label{eq:diraceq}
\end{alignat}
The propagator in the external field is defined, similarly to Eq.~\eqref{eq:freepropdef}, as the vacuum expectation value of time-ordered product
\begin{equation}
...
\end{equation}
for $n = 1,2,3,...$ and $\kappa = \pm 1,...,\pm(n-1),-n$.
