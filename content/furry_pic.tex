...
\label{ch:furry_pic}
In this thesis, relativistic atomic structure calculations for investigating nuclear effects on the energy levels of electrons or muons bound in the potential of an atomic nucleus are performed. This is based on solving the Dirac equation for the bound fermion in the nuclear potential. Here, the Dirac equation is often seen as a one particle equation describing the bound muon or electron. However, the one particle interpretation of the Dirac equation is problematic, especially if radiative effects like vacuum polarization are considered. The relativistic quantum field theory for describing the electromagnetic interaction on an atomic scale is quantum electrodynamics (QED). Therefore, in this chapter, the starting point is the Lagrangian of QED, and results will be derived from thereon.
%\begin{itemize}
